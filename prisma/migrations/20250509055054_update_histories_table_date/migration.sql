...
INSERT INTO "new_facebook_interaction_history" ("commented", "device_id", "finished_at", "id", "liked", "shared_groups_count") SELECT "commented", "device_id", "finished_at", "id", "liked", "shared_groups_count" FROM "facebook_interaction_history";
...
INSERT INTO "new_tiktok_interaction_history" ("commented", "device_id", "finished_at", "id", "liked", "total_views", "username", "video_saved") SELECT "commented", "device_id", "finished_at", "id", "liked", "total_views", "username", "video_saved" FROM "tiktok_interaction_history";
